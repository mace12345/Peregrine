...
__PySCF__ can run all sorts of quantum chemical calculations and is highly customisable. Only works on linux, so if useing windows please use __wsl__ to run __PySCF__.
