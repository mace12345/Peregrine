...
ATOMIC_VALENCE_ELECTRON_COUNT = {
    ...
    "Cs": 1,
    "Ba": 2,
    # Lanthanides — chemically nearly always Ln(III); set to 3 by convention
    "La": 3,
    "Ce": 4,
    "Pr": 5,
    "Nd": 6,
...
ATOMIC_PAULING_ELECTRONEGATIVITIES = {
    "H": 2.20,
    "He": None,
    "Li": 0.98,
    "Be": 1.57,
...
class Atom:
    ...
    def Update(self):
        ...
        if self.AtomicSymbol not in ATOMIC_MASSES and self.AtomicSymbol == "Du":
            ...
            self.IsMetal = None
            self.PaulingElectronegativity = None
        else:
